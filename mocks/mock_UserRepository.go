...
func (_m *MockUserRepository) List(ctx context.Context) ([]entity.User, error) {
	ret := _m.Called(ctx)
...
func (_c *MockUserRepository_List_Call) RunAndReturn(run func(context.Context) ([]entity.User, error)) *MockUserRepository_List_Call {
	_c.Call.Return(run)
	return _c
}

// ListPaginated provides a mock function with given fields: ctx, offset, limit
func (_m *MockUserRepository) ListPaginated(ctx context.Context, offset int, limit int) ([]entity.User, int64, error) {
...
func (_c *MockUserRepository_ListPaginated_Call) Return(_a0 []entity.User, _a1 int64, _a2 error) *MockUserRepository_ListPaginated_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockUserRepository_ListPaginated_Call) RunAndReturn(run func(context.Context, int, int) ([]entity.User, int64, error)) *MockUserRepository_ListPaginated_Call {
	_c.Call.Return(run)
	return _c
}
